...
function snakeGame(canvasWidth, canvasHeight, blockSize, delay){
	...
	this.canvas.style.border = "30px solid #ddd";
	...
	this.gameOver = function(){
		...
		this.ctx.strokeText("Appuyer sur la touche Espace pour rejouer", centerX, centerY -120);
		this.ctx.fillText("Appuyer sur la touche Espace pour rejouer", centerX, centerY -120);
		this.ctx.restore();
	};
	...
	function Snake(body, direction){
		...
		this.advance= function(){
			...
			switch(this.direction){/*pour analyser la direction*/
